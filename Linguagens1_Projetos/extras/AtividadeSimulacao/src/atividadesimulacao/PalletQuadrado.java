...
public class PalletQuadrado extends Pellet {
   ...
   static public int qtdProdutos(ICarregavel produto) { //static teoricamente
        Dimensoes a = produto.getDimensoes();

        int nLargura = (int) (PalletQuadrado.dim.largura / a.largura);
        int nComprimento = Math.floorDiv(PalletQuadrado.dim.comprimento, a.comprimento);
        
        int nAltura = (250- PalletQuadrado.dim.altura)/a.altura;
